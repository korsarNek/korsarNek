...
(function() {
  ...
  function localSearchFunc(path: string, searchSelector: string, resultSelector: string) {
    'use strict';
    ...
    jQuery.ajax({
      ...
      success : function(xmlResponse) {
        ...
        $input.on('input', function() {
          ...
          var content = $input.val() as string;
          var resultHTML = '';
          ...
          dataList.forEach(function(data) {
            ...
            var orig_data_content = data.content.replace(/<span[^>]+>/g, '').replace(/<[^>]+>/g, '\n').replace(/\n{2,}/g, '\n\n').trim();
  ...
  function localSearchReset(searchSelector: string, resultSelector: string) {
    'use strict';
    var $input = jQuery(searchSelector);
    var $result = jQuery(resultSelector);
